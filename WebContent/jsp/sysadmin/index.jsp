...
<div class="header">
    ...
    <div class="dl-log">欢迎您，<span class="dl-log-user">${sysAdmin.uname }</span><a href="${pageContext.request.contextPath }/sysadmin/quit" title="退出系统" class="dl-log-quit">[退出]</a>
    </div>
</div>
<div class="content">
